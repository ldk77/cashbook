...
<head>
	...
	td{border: 1px solid gray; padding: 3px; width: 300px; height: 100px; font-size: 15pt;}
...
<body id="page-top">
    ...
    <div id="wrapper">
		...
		<form id="signinForm" action="<%=request.getContextPath()%>/cash/updateCashAction.jsp" method="post">
